...
Before presenting, open the phone remote and the tower at `https://sundai.willsarg.com/curious-seal?view=street`. Turn the host volume up and prevent it from sleeping. The removed desktop preview is not needed; the building is the game board.
